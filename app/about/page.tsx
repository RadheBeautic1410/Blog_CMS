...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "Learn about our mission to share insights, tutorials, and ideas on technology, business, programming, and lifestyle.",
  alternates: {
    canonical: `${NEXT_PUBLIC_URL}/about`,
  },
  openGraph: {
    title: "About Us",
    description:
...
const values = [
  {
    ...
    description:
      "We curate and publish well-researched, insightful articles that add real value to our readers.",
  },
  {
    icon: (
      <svg
    ...
    title: "Learn & Grow",
    description:
      "From beginners to experts, we create content that helps everyone learn and level up.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "We believe in building a community of curious minds who support and inspire each other.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-rose-50/60 via-white to-indigo-50/50 relative">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden -z-10">
        <FlowerIcon
          className="absolute -right-8 top-20 h-40 w-40 fill-indigo-300/40 -rotate-12"
          aria-hidden
        />
        <FlowerIcon
          className="absolute -left-6 top-1/3 h-28 w-28 fill-violet-300/35 rotate-[15deg]"
          aria-hidden
        />
        <FlowerIcon
          className="absolute right-[20%] top-[55%] h-24 w-24 fill-rose-300/30 -rotate-[8deg]"
          aria-hidden
        />
        <FlowerIcon
          className="absolute left-[15%] bottom-[30%] h-32 w-32 fill-emerald-300/35 rotate-[20deg]"
          aria-hidden
        />
      </div>
      ...
      <main className="relative overflow-hidden">
        ...
        <section className="relative px-4 pt-20 pb-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            <div className="mb-6 inline-flex items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-100 to-violet-100 p-4">
              <FlowerIcon
                className="flower-spin h-14 w-14 fill-indigo-500"
                aria-hidden
              />
            </div>
            ...
            <p className="mt-6 text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed sm:text-xl">
              We&apos;re on a mission to share insights, tutorials, and ideas
              that inspire and inform. Welcome to our corner of the internet.
            </p>
          </div>
        </section>
        ...
        <section className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 pb-16">
          <div className="rounded-2xl border border-slate-200/80 bg-white/90 p-8 shadow-lg shadow-slate-200/40 sm:p-10 md:p-12">
            ...
            <div className="space-y-5 text-slate-600 leading-relaxed">
              <p>
                We started this blog with a simple idea: to create a space where
                curious minds can discover valuable content across technology,
                business, programming, and lifestyle. Whether you&apos;re here
                to learn something new, get inspired, or stay updated —
                we&apos;ve got you covered.
              </p>
              <p>
                Every article we publish is crafted with care. We focus on
                clarity, practical value, and honest perspectives. Our goal is
                to help you make better decisions, build new skills, and find
                ideas that matter.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            <div className="rounded-2xl bg-gradient-to-br from-indigo-50 to-violet-50/80 p-8 ring-1 ring-indigo-200/50">
              ...
              <p className="text-slate-600 leading-relaxed">
                To deliver high-quality, accessible content that empowers people
                to learn, grow, and stay informed in a fast-changing world.
              </p>
            </div>
            <div className="rounded-2xl bg-gradient-to-br from-violet-50 to-rose-50/80 p-8 ring-1 ring-violet-200/50">
              ...
              <p className="text-slate-600 leading-relaxed">
                To become a trusted resource where millions find inspiration,
                knowledge, and a community that values curiosity and growth.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 pb-24">
          <div className="rounded-3xl bg-gradient-to-br from-indigo-50 via-violet-50/80 to-rose-50/60 p-10 text-center shadow-lg shadow-indigo-200/20 ring-1 ring-indigo-200/40 sm:p-14">
            <FlowerIcon
              className="mx-auto h-12 w-12 fill-indigo-500/80 mb-6"
              aria-hidden
            />
            <h2 className="font-display text-2xl font-bold text-slate-900 sm:text-3xl">
              Ready to Explore?

...
export const metadata: Metadata = {
  ...
  description:
    "Learn how we collect, use, and protect your personal information when you use our blog and services.",
  alternates: {
    canonical: `${NEXT_PUBLIC_URL}/privacy`,
  },
  openGraph: {
    title: "Privacy Policy",
    description:
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-indigo-50/30 relative">
      <div className="pointer-events-none fixed inset-0 overflow-hidden -z-10">
        <FlowerIcon
          className="absolute -right-8 top-20 h-40 w-40 fill-indigo-300/30 -rotate-12"
          aria-hidden
        />
        <FlowerIcon
          className="absolute -left-6 top-1/2 h-28 w-28 fill-violet-300/25 rotate-[15deg]"
          aria-hidden
        />
      </div>

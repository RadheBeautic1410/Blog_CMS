  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed left-4 top-4 z-50 lg:hidden rounded-lg bg-white p-2 shadow-md border border-[#E5E7EB]"
      ...
      <aside
        className={`fixed left-0 top-0 z-40 h-screen w-64 bg-white border-r border-[#E5E7EB] transition-transform ${
